...
class NspBusinessGatekeeperApiService(models.AbstractModel):
    ...
    def api_controller_lane_calibration_events(self):
        ...
        try:
            ...
            # block behind this request until the outer Odoo transaction commits.
    ...
    def api_parking_detection_push(self):
        ...
        # Do not mutate Reader Observation from the raw Parking data plane.
        # /devices/report is the single writer for physical Reader telemetry.
        # This avoids row-lock coupling between high-volume acquisition requests
        # and the periodic reader-status worker.
